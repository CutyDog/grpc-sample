...
func (ec *executionContext) _Query_account(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		ec.marshalOAccount2ᚖgithubᚗcomᚋCutyDogᚋgrpcᚑsampleᚋservicesᚋgraphqlᚋgraphᚋmodelᚐAccount,
		true,
		false,
	)
}
...
func (ec *executionContext) marshalOAccount2ᚖgithubᚗcomᚋCutyDogᚋgrpcᚑsampleᚋservicesᚋgraphqlᚋgraphᚋmodelᚐAccount(ctx context.Context, sel ast.SelectionSet, v *model.Account) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
